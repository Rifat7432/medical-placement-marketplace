...
router.post('/change-password', auth(USER_ROLES.ADMIN, USER_ROLES.STUDENT, USER_ROLES.VENDOR), validateRequest(AuthValidation.createChangePasswordZodSchema), AuthController.changePassword);
